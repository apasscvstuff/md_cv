...
| :---------------------------- | :------------------------------- | :-------------------------------- |
| ✓ Python / C,C++              | ✓ AI Safety & Red Teaming        | ✓ Scikit-learn/Keras              |
| ✓ Docker/Kubernetes           | ✓ Attention Mechanisms           | ✓ NumPy/Pandas                    |
| ✓ Git/CI-CD                   | ✓ Constitutional AI              | ✓ RAG Systems                     |
...
| ✓ Research Methodology        | ✓ Vector Search (FAISS/Weaviate) | ✓ V&V (Verification & Validation) |
| ✓ System Architecture         | ✓ Transformer Architectures      | ✓ Data Engineering                |
...
* **Telemetry Pipeline Architecture:** Built end-to-end data pipeline from insulin pumps through gateway servers to Grafana dashboards, plus Python-based signal analysis tools for Hall effect sensor validation
* **Cross-functional Technical Leadership:**  Led firmware development from risk assessment through regulatory approval for FIH trials where patient safety was paramount. Implemented comprehensive risk control measures and exhaustive V&V protocols, created full traceability matrices, and delivered complete documentation package meeting ISO-13485/IEC-62304 standards. Zero safety incidents during trials.
...
* **Safety-Critical Architecture:** Implemented embedded architectures integrating third-party Bluetooth stacks with custom safety algorithms using systematic validation approaches
* **Critical System Debugging:** Led multi-week Root Cause Analysis to identify and resolve Bluetooth connectivity issue blocking clinical trial, applying systematic debugging methodology to safety-critical communications
* **Custom Research Firmware Development:** Gathered requirements from clinical researchers and designed specialized firmware systems for internal trials. For Insulin Compatibility Testing, redesigned data models for long-term measurements, implemented autonomous pumping protocols for 2-week unattended operation, and developed accompanying tools for real-time remote monitoring and log analysis
...
* **End-to-End System Development:** Led complete development of heterogeneous FPGA + Python platform for neural signal acquisition - from hardware selection and architecture design through implementation, testing, validation, and technical documentation. System integrated custom ASICs with FPGA control logic and Python processing pipeline for 300+ channel neural data
* **Multi-channel Signal Processing:** Developed signal processing architecture handling 300+ parallel channels at 50-60Hz, demonstrating feasibility of large-scale data processing system design for real-time applications
* **Startup R&D Environment:** Worked independently in fast-paced medical device startup at EPFL Innovation Park, adapting quickly to evolving technical requirements
...
* **Technical Curriculum Development:** Created comprehensive 40-hour ML curriculum for 100+ international executives, structuring complex technical concepts for diverse professional audiences
...
* **FPGA-CPU Communication:** Implemented heterogeneous FPGA+CPU platform with 2Mbps UART interface for real-time data processing
...
- **Hybrid RAG System Implementation:** Built functional RAG system with FAISS and Weaviate vector database support, backend switching between local LLMs and APIs, comprehensive document processing pipeline, and neural reranking
...
- **Containerized Deployment:** Deployed Docker-based solution with Weaviate vector database integration and LLM pipeline supporting local and cloud deployment
...
- **Performance Optimization Engineering:** Achieved 6x inference speedup through custom MPS kernels and 40% memory reduction via magnitude-based pruning, INT8/INT4 quantization, and mixed precision training, implementing training infrastructure optimization approach
- **AI Safety Framework Implementation:** Developed a baseline Constitutional AI safety evaluation system with comprehensive red teaming suite testing adversarial cases, aiming for a systematic approach to AI safety methodology and evaluation frameworks
...
- **Large-Scale Data Processing:** Built distributed computing pipeline handling 1TB+ datasets using PySpark on standard hardware
...
Data Science and Embedded Systems specialization with Machine Learning research and heterogeneous systems security research
...
High-performance computing with hardware acceleration, parallel processing projects, and research-oriented bachelor's thesis
